...
Emo Vote let's you encourage your users be letting them express their feelings by "emoting" rather then voting.
...
1. Unzip.
1. Upload the `emo-vote/` folder to your `/wp-content/plugins/` directory.
1. Activate the plugin through the Plugins menu in WordPress.
1. Navigate to Settings > Emo Vote and customize it as you wish.
1. Place `<?php emo_vote_display('No votes','One vote','% votes'); ?>` (localize the strings be replacing the parameters according to your current locale) in your template, for instance in `index.php` and `single.php`.
